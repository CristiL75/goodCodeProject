...
const ProblemDetail2 = () => {
    ...
    const [functionHeader, setFunctionHeader] = useState('function lengthOfLongestSubstring(s) { }');
        ...
        try {
            ...
            for (let testCase of testCases) {
                ...
                try {
                    ...
                    const actualOutput = result.run.stdout ? JSON.parse(result.run.stdout.trim()) : null;
