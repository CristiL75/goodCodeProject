...
const ProblemDetail3 = () => {
    ...
    const [functionHeader, setFunctionHeader] = useState('function findMedianSortedArrays(nums1, nums2) { }');
        ...
        try {
            ...
            for (let testCase of testCases) {
                ...
                try {
                    ...
                    let actualOutput = result.run.stdout ? parseFloat(result.run.stdout.trim()) : null;
